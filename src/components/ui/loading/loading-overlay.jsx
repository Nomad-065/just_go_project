...
export default function LoadingOverlay({visible, message = "Loading...", blur = true}) {
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center space-y-4">
        ...
        <span className="text-white text-lg font-semibold font-work-sans text-outline-black-30">{message}</span>
      </div>
    </div>
  );
}
